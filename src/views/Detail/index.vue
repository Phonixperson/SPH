          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="attr in spuSaleAttrList" :key="attr.id">
                ...
                <dd changepirce="0" v-for="attrValue in attr.spuSaleAttrValueList" :key="attrValue.id"
                  :class="{active:attrValue.isChecked == 1}" @click="changeActive(attrValue,attr.spuSaleAttrValueList)"
