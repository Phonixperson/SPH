        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{ active: orderTypeZonghe }" @click="genOrder">
                  <a href="#" 
                    >综合
                    <!-- 使用综合排序且顺序为降序 -->
                    <span v-show="orderTypeZonghe && downOrder">⬇</span>
                    <span v-show="orderTypeZonghe && (!downOrder)">⬆</span>
                  </a>
                </li>
                <li @click="priceOrder" :class="{ active: !orderTypeZonghe }">
                  <a href="#" :class="{ active: orderTypeZonghe }"
                    >价格
                    <span v-show="(!orderTypeZonghe)&&downOrder">⬇</span>
                    <span v-show="(!orderTypeZonghe)&&!downOrder">⬆</span>
                  </a>
  ...
  methods: {
    ...
    priceOrder() {
      if (this.searchParams.order.split(":")[0] != "2") {
        ...
        if (this.searchParams.order == "2:desc") {
